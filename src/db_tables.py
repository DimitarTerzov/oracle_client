...
class Sandbox:
    ...
    def insert_statement(self):
        ...
        INSERT_TS, MODIFIED_TS, MODIFIED_BY, RECORD_VER, SANITIZED, DYN_UNIQUE_ISSUE_POP_STATUS,
        DYN_UNIQ_ISSU_CHKSM_POP_STS, DYN_UNIQ_ISSU_POP_RETRY_CNT, DELETED_FILES,
        EXPIRED_TS, PURGE_ON_PROMOTE, AUTO_RECREATE) VALUES {}""".format(params_as_list(self._column_count))
        return sql
...
class AppVer:
    ...
    def insert_statement(self):
        sql = """
        insert into APP_VER (APP_VER_ID, SANDBOX_ID, PREV_APP_VER_ID, PLATFORM_ID,
        ACCOUNT_ID, LOGIN_ACCOUNT_ID, VERSION_LABEL, COMMENTS, NAS_DIR, LIFECYCLE_STAGE_ID,
        SHIP_TS, TPL_SEARCH_INDEX_VER, TPL_SEARCH_INDEX_STATE, CMP_TPL_SEARCH_INDEX_VER,
        CMP_TPL_SEARCH_INDEX_STATE, DELETED, DELETED_FILES, LAST_AUDITOR_ID, AUTOPUB_DISABLED,
        POLICY_ID, LAST_COMP_CHECK_TS, GRACE_TS, SCORE_GRACE_TS, SCAN_FREQ_TS, POLICY_STATUS,
        RULES_STATUS, POLICY_REASON, MIN_SCORE_STATUS, IS_DYNAMICMP, BINARIES_DELETED,
        SANITIZED, REMEDIATION_SCAN, REEVALUATE_SEVERITY, POLICY_EVALUATED_ON_ISSUE, INSERT_TS,
        MODIFIED_TS, MODIFIED_BY, RECORD_VER, AUTO_SCAN, PREFLIGHT_FILE_NAME,
        NON_FATAL_SCAN, SCA_RULE_STATUS, SCA_GRACE_TS, SUMMARIES_DELETED, RT_DELETED,
        LAST_SCA_MITIGATION_ID, LAST_POLICY_UPDATE_TS, NEEDS_REPORT_DATA_UPDATE, IS_ONEWAS,
        BINARIES_ARCHIVED, TEMPLATES_ARCHIVED, DELETED_EMPTY_EXEC_DIRS, BINARIES_ON_S3,
        S3_BUCKET_ID, IS_STACK_FRAME_DELETED) VALUES {}""".format(params_as_list(self._column_count))
        return sql

    def values_to_insert(self):
        values = (
            self.id, self.sandbox_id, None, 208,
            1, 10520, 'Mon Apr 06 22:26:58 EDT 2020',
            None, 'veracode/app20157399/ver69555',
            807, None, None, 1, None, 1, 0, 0,
...
class Analysis:
    ...
    def insert_statement(self):
        ...
        MODIFIED_BY, RECORD_VER) VALUES {}""".format(params_as_list(self._column_count))
        return sql
...
class AnalysisUnit:
    ...
    def insert_statement(self):
        ...
        SALES_PUBLISH_PRIORITY, PROGRESS_SCORE, WEBAPP, AUTO_PUB_STATUS, DYNAMIC_SCAN_TYPE,
        ...
        SANITIZED, INSERT_TS, MODIFIED_TS, MODIFIED_BY, RECORD_VER, FIXED_FLAW_STATE,
        IS_PARTIAL_RESULTS_READY, SENT_INCREMENTAL_PUBLISH_EMAIL, NEEDS_FIXED_REOPENED_RECALC,
        CODEBASE_PRICING_SIZE, USED_CODEBASE_PRICING_SIZE, UNSUBMITTED_STATIC_NOTICE_TS)
        VALUES {}""".format(params_as_list(self._column_count))
        return sql
...
class AnalysisUnitDynParams:
    ...
    def insert_statement(self):
        ...
        CRAWL_SEQ_FILE_NAME, CRAWL_SEQ_FILE_TYPE, USER_AGENT, CLIENT_CERT_FILE_NAME,
        ...
        DYN_SCAN_NEEDS_APPROVAL, DYN_SCAN_ON_VSA_NEEDS_APPROVAL, DYN_SCAN_HOLDS_RELEASED,
        BOTH_HTTP_HTTPS, LOGOUT_DETECTOR, VSA_ID, VSA_GROUP_ID, OVERRIDE_GROUP_ID,
        ...
        INSERT_TS, MODIFIED_TS, MODIFIED_BY, RECORD_VER, MULTITHREADING, RESCAN_TYPE,
        VERIFY_FLAW_COUNT, ALTERNATOR_MODE, LOGOUT_SEQ_FILE_NAME, CUSTOM_DEFINED_TECHNOLOGIES,
    ...
    def values_to_insert(self):
        values = (
            ...
            '"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.0 Safari/537.36/Veracode Security Scan/support@veracode.com"',
...
class ScanEncrypt:
    ...
    def values_to_insert(self):
        values = (
            ...
            '',
            None, 7,
